## O Programa é feito utilizando laravel 8.5.9, então é nécessario a instalarção do larevel, [clique aqui para saber como instalar](https://laravel.com/docs/10.x/installation)
